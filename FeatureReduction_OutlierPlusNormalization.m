...
alpha = 0.01;
iterations = 60000; % Obtained after a few hit and trials.
...
% Call the function to normalize the input matrix
...
X_norm = [ones(m, 1) normalizedInputMatrix(1:550, :)];   % The normalized X
